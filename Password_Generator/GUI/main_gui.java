...
public class main_gui extends JFrame implements ChangeListener, ItemListener {
    ...
    public static void main(String[] args) {
        ...
        // check password
        JButton btp=new JButton("Check your password strength here");
        btp.setBounds(700,500,250,50);
        btp.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	...
            	Password psd=new Password(s);
            	psd.PasswordStrength();
            	String result=psd.calculateScore();
            	tp.setText(result);
            }
        });
        f.add(btp);
        ...
        tp = new JTextField("Password /Enter you password ");
        tp.setBounds(250, 400, 700, 50);
